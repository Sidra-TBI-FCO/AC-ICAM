...
# Load data
load("./Processed_Data/RNASeq/GRCh37_Trimmed_p/Normalized/JSREP.Complete.dataset.EDAseq.QN.HPC.Rdata")
...
colnames(RNASeq.QN.LOG2) = gsub("T", "T_P", colnames(RNASeq.QN.LOG2))
colnames(RNASeq.QN.LOG2) = gsub("P.B", "B", colnames(RNASeq.QN.LOG2))
colnames(RNASeq.QN.LOG2) = gsub("P.C", "C", colnames(RNASeq.QN.LOG2))
colnames(RNASeq.QN.LOG2) = gsub("LM", "LM1", colnames(RNASeq.QN.LOG2))
colnames(RNASeq.QN.LOG2) = gsub("LM11", "LM1", colnames(RNASeq.QN.LOG2))
colnames(RNASeq.QN.LOG2) = gsub("LM12", "LM2", colnames(RNASeq.QN.LOG2))

# Add leading zero
colnames(RNASeq.QN.LOG2) = str_pad(colnames(RNASeq.QN.LOG2), pad = "0", 6)
nchar(colnames(RNASeq.QN.LOG2))
...
colnames(RNASeq.QN.LOG2) = gsub("T_P", "-PT-01-A-02", colnames(RNASeq.QN.LOG2))
colnames(RNASeq.QN.LOG2) = gsub("LM1", "-LM-01-A-02", colnames(RNASeq.QN.LOG2))
colnames(RNASeq.QN.LOG2) = gsub("LM2", "-LM-02-A-02", colnames(RNASeq.QN.LOG2))
colnames(RNASeq.QN.LOG2) = gsub("T_B", "-PT-02-A-02", colnames(RNASeq.QN.LOG2))
colnames(RNASeq.QN.LOG2) = gsub("T_C", "-PT-03-A-02", colnames(RNASeq.QN.LOG2))
...
write.csv(RNASeq.QN.LOG2, file = "./Processed_Data/Shared_Data/For cbioportal/2405_2021_SER-SILU-RNASeq_QN_LOG2_GRCh37_for_cbioportal.csv") 
