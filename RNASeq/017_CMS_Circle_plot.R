...
png(paste0("./Figures/Trimmed_p/017_CMS_Circle_plot/017_", location, "_348_CMS_Pie_Chart.png"),
    height = 7, width = 7, units = "in", res = 600)
plot(plot)
dev.off()

png(paste0("./Figures/Trimmed_p/017_CMS_Circle_plot/017_Stacked_barchart_by_tumor_anatomic_location.png"),
    height = 6, width = 10, units = "in", res = 600)
plot(plot2)
dev.off()

png(paste0("./Figures/Trimmed_p/017_CMS_Circle_plot/017_Stacked_barchart_count_by_tumor_anatomic_location.png"),
    height = 6, width = 10, units = "in", res = 600)
plot(plot3)
dev.off()
