...
# Set parameters
Gene_set = "Thorsson" #"Selected.pathways.Sidra.LUMC" # "Cholesterol_list" "MSigDB_list" "Angelove_ORIG" "Bindea_ORIG" "ICR" "Bindea_PATRICK" "Thorsson" "Prat_ORIG_NANO" "Trajanoski_ORIG"  "Thorsson" "Benci_list" "Selected.pathways" "TIS" "Specific genes"
subset = ""
