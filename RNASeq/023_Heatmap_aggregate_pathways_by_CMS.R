...
png(paste0("./Figures/Trimmed_p/023_aggr_Heatmap_ES/v3_April_2021_Aggregated_heatmap_", geneset, ".png"),
    res = 600, width = 6.5, height = 12, units = "in")
...
ha = HeatmapAnnotation(CMS = colnames(plot_df_agg_z),
                       ...
                       show_legend = FALSE,
                       annotation_name_gp = gpar(fontsize = 17))
png(paste0("./Figures/Trimmed_p/023_aggr_Heatmap_ES/v3_April_2021_Aggregated_heatmap_", geneset, "_Tolga_excluded.png"),
    res = 600, width = 5.3, height = 11, units = "in")
Heatmap(plot_df_agg_z, cluster_rows = TRUE, cluster_columns = FALSE,
        show_column_names = FALSE, top_annotation = ha, name = "Mean enrichment score (z-scored)",
        show_heatmap_legend = FALSE,
        row_names_max_width = unit(7, "in"),
