...
png(paste0("./Figures/Trimmed_p/025_Correlation_matrix_ES/025_v4_", 
           Tolga_pathway_excluded, "_Heatmap_Pearson_Correlation.png"),
    width = 5, height = 8, units = "in", res = 600)
Heatmap(mat, cluster_rows = FALSE, cluster_columns = FALSE,
        col = col_fun, top_annotation = ha, show_heatmap_legend = FALSE,
