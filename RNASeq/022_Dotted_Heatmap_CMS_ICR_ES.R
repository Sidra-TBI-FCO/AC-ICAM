...
png(paste0("./Figures/Trimmed_p/022_Dotted_Heatmap_ES/test_ICR_continuous_Dotted_heatmap_", geneset, ".png"),
    res = 600, width = 8.0, height = 4.5, units = "in") # Previously height = 4
