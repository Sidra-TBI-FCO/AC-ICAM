...
png(paste0("./Figures/Trimmed_p/Kaplan Meier Plots/July_2020_",str_c(exclude, collapse = "_"), "_",
           exclude_stage_IV, "_", exclude_adjuvant,"_Overall_Survival_", Group.of.interest,"_Surv_cutoff_years_",Surv.cutoff.years,".png"),res=600,height=6,width=8,unit="in")  # set filename
ggkm(mfit,
     timeby=12,
