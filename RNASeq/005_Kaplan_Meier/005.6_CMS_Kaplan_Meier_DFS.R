...
# plots
png(paste0("./Figures/Trimmed_p/Kaplan Meier Plots/Sept_2020_", ICR, "_", str_c(exclude, collapse = "_"),
           exclude_stage_IV, "_", exclude_adjuvant,"_DFS_", Group.of.interest,"_Surv_cutoff_years_",Surv.cutoff.years,".png"),
...
png(paste0("./Figures/Trimmed_p/005_ggsurv_plots/Sept_2020_", ICR, "_", str_c(exclude, collapse = "_"),
           exclude_stage_IV, "_", exclude_adjuvant,"_DFS_", Group.of.interest,"_Surv_cutoff_years_",Surv.cutoff.years,".png"),
