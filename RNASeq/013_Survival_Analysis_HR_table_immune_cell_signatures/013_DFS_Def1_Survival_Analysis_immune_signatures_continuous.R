...
exclude_stage_IV = ""
included_stages = "All" # c(1, 2, 3) # "All" or c(1, 2, 3)
Surv.cutoff.years = 20
exclude = c("Conpair_lower_90_percent", "non-epithelial") #"Conpair_lower_90_percent" 
Source = "v2_All" # "All" or "ConsensusTME_WJ_edit"
# c("Conpair_lower_90_percent", "non-epithelial")


# Load data
load("./Processed_Data/Survival Data/JSREP_clinical_data.Rdata")
load(paste0("./Analysis/Trimmed_p/012_Immune_gene_signatures_table/012_", Source, "_Immune_gene_signatures_table.Rdata"))
...
save(HR_table, file = paste0("./Analysis/Trimmed_p/013_Immune_signatures_survival/013_", Source, "_DFS_Def1_HR_table_exclude_",
