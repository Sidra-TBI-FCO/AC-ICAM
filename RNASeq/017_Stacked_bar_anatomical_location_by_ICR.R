...
png(paste0("./Figures/Trimmed_p/017.2_Stacked_barplot/017_Stacked_barchart_ICR_by_tumor_anatomic_location.png"),
...
png(paste0("./Figures/Trimmed_p/017.2_Stacked_barplot/017.2_", location, "_348_ICR_Pie_Chart.png"),
