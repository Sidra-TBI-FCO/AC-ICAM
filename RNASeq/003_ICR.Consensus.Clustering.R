...
#save data
outputname = paste0("~/Dropbox (TBI-Lab)/DB-LAB/Projects - Data/02 Active Projects/SDR100029_JSREP_2016_WH_Colon_Cancer_NGS/NGS_Data/Analysis/Trimmed_p/ICR Consensus Clustering/JSREP_ICR_cluster_assignment_k2-6.Rdata")
