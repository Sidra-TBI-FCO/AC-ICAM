...
# Set parameters
Type = "Normalized"  # "Normalized" or "Relative"

# Load data

load(paste0("./Processed_Data/Microbiome/001_data_preparation/OTU_tables/", Type,"_abundancies/clean_paired_V3.2_sil_OTU_table.Rdata"))
...
save(Kingdom_abundance, Phylum_abundance, Class_abundance, Order_abundance, Family_full_abundance,
     Genus_full_abundance, Species_full_abundance, file = paste0("./Processed_Data/Microbiome/001_data_preparation/OTU_tables/", Type,"_abundancies/clean_paired_rank_level_abundancies.Rdata"))
