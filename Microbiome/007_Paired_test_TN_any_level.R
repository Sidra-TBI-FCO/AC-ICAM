...
dir.create("./Figures/Microbiome/007_Paired_wilcoxon_test_TN", showWarnings = FALSE)
dir.create(paste0("./Figures/Microbiome/007_Paired_wilcoxon_test_TN/", Type), showWarnings = FALSE)
dir.create(paste0("./Figures/Microbiome/007_Paired_wilcoxon_test_TN/", Type, "/", Rank), showWarnings = FALSE)
...
for (i in 1:nrow(rank_abundancies)){
  ...
  if(test$p.value < 0.05 | make_plot == "make_plot"){
    ...
    png(paste0("./Figures/Microbiome/007_Paired_wilcoxon_test_TN/", Type, "/", Rank, "/",
...
dir.create("./Analysis/Microbiome/007_Paired_wilcoxon_test_TN", showWarnings = FALSE)
dir.create(paste0("./Analysis/Microbiome/007_Paired_wilcoxon_test_TN/",  Type), showWarnings = FALSE)
dir.create(paste0("./Analysis/Microbiome/007_Paired_wilcoxon_test_TN/",  Type, "/", Rank), showWarnings = FALSE)

save(results, file = paste0("./Analysis/Microbiome/007_Paired_wilcoxon_test_TN/",  Type, "/", Rank,
                            "/Wilcoxon_test_", Type, "_", Rank, ".Rdata"))
write.csv(results, file = paste0("./Analysis/Microbiome/007_Paired_wilcoxon_test_TN/",  Type, "/", Rank,
                                 "/Wilcoxon_test_", Type, "_", Rank, ".csv"),
          row.names = FALSE)
