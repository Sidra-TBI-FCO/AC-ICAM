...
dir.create("./Figures/Microbiome/007.2_Paired_wilcoxon_test_TN_facet_ICR_cluster", showWarnings = FALSE)
dir.create(paste0("./Figures/Microbiome/007.2_Paired_wilcoxon_test_TN_facet_ICR_cluster/", Type), showWarnings = FALSE)
dir.create(paste0("./Figures/Microbiome/007.2_Paired_wilcoxon_test_TN_facet_ICR_cluster/", Type, "/", Rank), showWarnings = FALSE)
...
for (i in 1:nrow(rank_abundancies)){
  ...
  if(make_plot == "make_plot" | mean > 0.001){
    ...
    png(paste0("./Figures/Microbiome/007.2_Paired_wilcoxon_test_TN_facet_ICR_cluster/", Type, "/", Rank, "/v3_",
               micr, "_paired_boxplot_N_T.png"), res = 600, units = "in", width = 5.5, height = 3.5)
    plot(plot)
    dev.off()
