...
for (i in 1:nrow(rank_abundancies)){
  ...
  if(make_plot == "make_plot" | mean > 0.001){
    ...
    png(paste0("./Figures/Microbiome/007.4_Paired_wilcoxon_test_TN/", Type, "/", Rank, "/v1_",
    ...
    #png(paste0("./Figures/Microbiome/007.4_Paired_wilcoxon_test_TN_facet_ICR_cluster/", Type, "/", Rank, "/Facet_TN_x_ICR_",
