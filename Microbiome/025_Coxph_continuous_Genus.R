...
abundance_delta = abundance_T - abundance_N
...
write.csv(results, file = paste0("./Analysis/Microbiome/025_Coxph_continuous_Genus_level/025_Coxph_stats_Genus_continuous_OS_", Tissue, ".csv"),
          row.names = FALSE)
