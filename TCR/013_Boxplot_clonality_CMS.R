...
dir.create("./Figures/TCR/013_Boxplot_clonality_CMS", showWarnings = FALSE)
png(filename = "./Figures/TCR/013_Boxplot_clonality_CMS/Boxplot_clonality_ICR_cluster.png",
    width = 3, height = 3.8, units = "in", res = 600)
plot(plot)
dev.off()

png(filename = "./Figures/TCR/013_Boxplot_clonality_CMS/Violin_plot_clonality_CMS_no_stats.png",
    width = 3, height = 3.8, units = "in", res = 600)
plot(violin_plot)
dev.off()
