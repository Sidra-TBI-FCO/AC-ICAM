...
# Set parameters
clones = "Overlapping"         # which clones (Tumor restricted, Overlapping, Normal restricted)
...
for (i in 1:10){
  ...
  png(paste0("./Figures/TCR/7_Overlapping_sequences_scatterplots/7.2_Histograms_Clone_distribution/7.2_Patient_", Patient, "_Histogram_",  
