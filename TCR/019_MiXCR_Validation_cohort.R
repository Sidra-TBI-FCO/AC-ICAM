...
test_cohort = TCR_Overview$Patient_ID
MiXCR$Cohort = NA
MiXCR$Cohort[which(MiXCR$Patient_ID %in% test_cohort)] = "test"
MiXCR$Cohort[-which(MiXCR$Patient_ID %in% test_cohort)] = "validation"

MiXCR$Cohort[which(is.na(MiXCR$MiXCR_Clonality))] = "no_MiXCR_data"
...
png(paste0("./Figures/TCR/019_MiXCR_ICRscore_in_validation_cohort/019_Scatter_MiXCR_ICRscore_Complete_cohort.png"),
