...
dir.create("./Figures/TCR/012_Boxplot_clonality_ICR_clusters", showWarnings = FALSE)
png(filename = "./Figures/TCR/012_Boxplot_clonality_ICR_clusters/Boxplot_clonality_ICR_cluster.png",
    width = 3, height = 3.8, units = "in", res = 600)
plot(plot)
dev.off()

png(filename = "./Figures/TCR/012_Boxplot_clonality_ICR_clusters/Violin_plot_clonality_ICR_cluster_no_stats.png",
    width = 3, height = 3.8, units = "in", res = 600)
plot(violin_plot)
dev.off()
