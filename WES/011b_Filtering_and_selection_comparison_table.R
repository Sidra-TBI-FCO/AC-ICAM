...
dir.create("./Figures/WES/011_Frequently_mutated_genes", showWarnings = FALSE)
png("./Figures/WES/011_Frequently_mutated_genes/v4_Barplot_frequently_mut_genes.png",
    width = 32, height = 1.8, units = "in", res = 600)
    #width = 18, height = 2.4, units = "in", res = 600)
plot(plot)
dev.off()

svg("./Figures/WES/011_Frequently_mutated_genes/v4_Barplot_frequently_mut_genes.svg",
    width = 32, height = 1.8, pointsize = 12)
#width = 18, height = 2.4, units = "in", res = 600)
plot(plot)
dev.off()
