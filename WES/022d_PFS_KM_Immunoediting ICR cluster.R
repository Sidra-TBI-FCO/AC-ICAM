...
# Set parameters
exclude_medium = "include_medium" # "include_medium_cat" "include_medium" or "exclude_medium"
...
png(paste0("./Figures/WES/022_Ratio_Neoantigens_Mutational_load_exploration/ggsurvplots/PFS_ggsurv_Dec_2020_OS_by_ICR_cluster_and_immunoediting_", Stages, "_",
