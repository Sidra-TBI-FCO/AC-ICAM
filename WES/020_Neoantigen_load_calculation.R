...
png("./Figures/WES/020_Neoantigen_load_calculation/Filtered_vs_Unfiltered_counts.png",
    res = 600, width = 5, height = 5, units = "in")
plot(plot)
dev.off()

save(neoantigen_df, file = "./Analysis/WES/020_Mut_Load_and_Neoantigen/All_samples_filtered_Neoantigen_count.Rdata")
...
save(frequency_df, file = "./Analysis/WES/020_Mut_Load_and_Neoantigen/Nonsilent_mutation_frequency_and_filtered_Neoantigen_count.Rdata")
...
png("./Figures/WES/020_Neoantigen_load_calculation/Mut_load_versus_Neoantigen_count.png",
