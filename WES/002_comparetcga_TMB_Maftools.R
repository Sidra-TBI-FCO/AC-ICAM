...
tcga_available()
tcga_load(study = "COAD", source = "MC3", reassign = FALSE)
...
png("./Figures/WES/002_tcgaCompare_TMB/v7_Sidra-LUMC_tcgaCompare_TMB.png", res = 600, 
    height = 4, width = 8, units = "in")
silu.mutload = tcgaCompare(maf = silu, cohortName = 'SILU-COAD')
dev.off()

png("./Figures/WES/002_tcgaCompare_TMB/v5_Sidra-LUMC_tcgaCompare_TMB_per_Mb_capture_size_40.png", res = 600, 
    height = 6, width = 12, units = "in")
silu.mutload = tcgaCompare(maf = silu, cohortName = 'SILU-COAD', tcga_capture_size = 40, capture_size = 40)
dev.off()
