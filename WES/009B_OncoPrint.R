...
png(paste0("./Figures/WES/009_Oncoprint/009_Oct_2021_", version, "_OncoPrint.png"), res = 600, width = 11, height = 7, # 11 #7.5,  #20 #18
    units = "in")
oncoPrint(mat,
...
svg(paste0("./Figures/WES/009_Oncoprint/009_Oct_2021_", version, "_OncoPrint.svg"), pointsize = 12, width = 11, height = 7, # 11 #7.5,  #20 #18
    )
oncoPrint(mat,
          alter_fun = alter_fun, col = col, 
          column_title = column_title, heatmap_legend_param = heatmap_legend_param,
