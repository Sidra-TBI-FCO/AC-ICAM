...
# Set parameters
version = "glm_1"  # "glm_1" for linear model genes that inversely correlate with ICR, "glm_2" for linear model genes that positively correlate with ICR, glm_3 overall
