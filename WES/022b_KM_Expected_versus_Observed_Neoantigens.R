...
frequency_df$Expected_neoantigen_count[which(frequency_df$Expected_neoantigen_count < 0 )] = 0
...
frequency_df$Immunoediting_score[which(frequency_df$Immunoediting_score == Inf)] = 5
...
table(frequency_df$Immunoedited, exclude = NULL)
...
if(Group.of.interest == "Immunoedited"){
...
#png(paste0("./Figures/WES/022_Ratio_Neoantigens_Mutational_load_exploration/ggkm_", subset, "_by_immunoediting_status_", 
...
png(paste0("./Figures/WES/022_Ratio_Neoantigens_Mutational_load_exploration/ggsurvplots/Dec_2020_ggsurv_", subset, "_by_immunoediting_status_", 
           Group.of.interest, "_", Stage_name, "_", Treatment, ICR_filter,".png"),
