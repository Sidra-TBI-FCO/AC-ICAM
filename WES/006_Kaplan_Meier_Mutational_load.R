...
# plots
#png(paste0("./Figures/WES/006_Mutational_load_KM/Overall_Survival_", Group.of.interest, "_", exclude_adjuvant, "_",
...
png(paste0("./Figures/WES/006_Mutational_load_KM/006_ggsurv_plots/Dec_2020_", Survival_outcome, "_", Group.of.interest, "_", exclude_adjuvant, "_",
            exclude_stage_IV, ICR, "_Surv_cutoff_years_", Surv.cutoff.years,".png"),
